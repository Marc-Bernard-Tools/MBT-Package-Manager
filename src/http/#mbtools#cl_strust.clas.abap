...
CLASS /mbtools/cl_strust IMPLEMENTATION.
  ...
  METHOD _unlock.
    ...
    TRY.
      ...
      CATCH cx_sy_file_open.
        /mbtools/cx_exception=>raise( |Error deleting file { mv_tempfile }| ).
      CATCH cx_sy_file_authority.
        /mbtools/cx_exception=>raise( |Not authorized to delete file { mv_tempfile }| ).
    ENDTRY.
