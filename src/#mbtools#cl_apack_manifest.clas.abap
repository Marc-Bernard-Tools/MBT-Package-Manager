************************************************************************
* /MBTOOLS/CL_APACK_MANIFEST
* MBT APACK Manifest
*
* This definition must matches ZCL_ABAPGIT_APACK_MIGRATION as defined by abapGit
* (see https://github.com/larshp/abapGit/blob/master/
...
************************************************************************
CLASS /mbtools/cl_apack_manifest DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS /MBTOOLS/CL_APACK_MANIFEST IMPLEMENTATION.
  ...
  METHOD run.
    ...
    DATA: lo_apack_migration TYPE REF TO /mbtools/cl_apack_manifest.
