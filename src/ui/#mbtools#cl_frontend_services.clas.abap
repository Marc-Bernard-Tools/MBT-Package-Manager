...
************************************************************************
CLASS /mbtools/cl_frontend_services DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS /MBTOOLS/CL_FRONTEND_SERVICES IMPLEMENTATION.
  ...
  METHOD /mbtools/if_frontend_services~file_upload.
  ...
  METHOD /mbtools/if_frontend_services~show_file_open_dialog.
    ...
    IF lv_action = cl_gui_frontend_services=>action_cancel.
      /mbtools/cx_exception=>raise( 'Cancelled' ).          "#EC NOTEXT
    ENDIF.
  ...
  METHOD /mbtools/if_frontend_services~show_file_save_dialog.
