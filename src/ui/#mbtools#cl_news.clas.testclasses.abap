...
CLASS /mbtools/cl_news DEFINITION LOCAL FRIENDS ltcl_news.
...
CLASS ltcl_news IMPLEMENTATION.
  ...
  METHOD version_to_numeric.
    ...
    lv_version_act = /mbtools/cl_news=>version_to_numeric( '1.23.10' ).
  ...
  METHOD compare_versions.
    ...
    lv_result = /mbtools/cl_news=>compare_versions( iv_a = '1.28.10'
                                                    iv_b = '1.23.10' ).
  ...
  METHOD normalize_version.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_news=>normalize_version( '1.28.10' )
      exp = '1.28.10' ).

    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_news=>normalize_version( 'v1.28.10' )
      exp = '1.28.10' ).

    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_news=>normalize_version( 'b1.28.10' )
      exp = '' ).

    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_news=>normalize_version( 'x.y.z' )
      exp = '' ).
  ...
  METHOD parse_line.
    ...
    DATA: ls_log TYPE /mbtools/cl_news=>ty_log.

    ls_log = /mbtools/cl_news=>parse_line(
      iv_line            = '======'
  ...
  METHOD parse.
    ...
    lt_log_act = /mbtools/cl_news=>parse(
