...
CLASS ltcl_gui_utils IMPLEMENTATION.
  ...
  METHOD is_renderable.
    ...
    cl_abap_unit_assert=>assert_equals( exp = abap_true
                                        act = /mbtools/cl_gui_utils=>is_renderable( lo_renderable ) ).
    cl_abap_unit_assert=>assert_equals( exp = abap_false
                                        act = /mbtools/cl_gui_utils=>is_renderable( lo_handler ) ).
  ...
  METHOD is_event_handler.
    ...
    cl_abap_unit_assert=>assert_equals( exp = abap_false
                                        act = /mbtools/cl_gui_utils=>is_event_handler( lo_renderable ) ).
    cl_abap_unit_assert=>assert_equals( exp = abap_true
                                        act = /mbtools/cl_gui_utils=>is_event_handler( lo_handler ) ).
