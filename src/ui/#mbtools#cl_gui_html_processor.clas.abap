...
************************************************************************
CLASS /mbtools/cl_gui_html_processor DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS c_preprocess_marker TYPE string VALUE `<!-- MBT HTML preprocessor -->` ##NO_TEXT.
    CONSTANTS c_comment_start TYPE string VALUE `<!--` ##NO_TEXT.
    CONSTANTS c_comment_end TYPE string VALUE `-->` ##NO_TEXT.

    METHODS constructor
      IMPORTING
        !ii_asset_man TYPE REF TO /mbtools/if_gui_asset_manager .
...
CLASS /MBTOOLS/CL_GUI_HTML_PROCESSOR IMPLEMENTATION.
  ...
  METHOD /mbtools/if_gui_html_processor~process.
    ...
    DATA lo_css_processor TYPE REF TO /mbtools/cl_gui_css_processor.
