CLASS ltcl_parse_data DEFINITION FOR TESTING DURATION SHORT RISK LEVEL HARMLESS.
  ...
  PRIVATE SECTION.
    METHODS:
      setup,
      test_1 FOR TESTING RAISING /mbtools/cx_exception,
      test_2 FOR TESTING RAISING /mbtools/cx_exception,
      test_3 FOR TESTING RAISING /mbtools/cx_exception,
      test_4 FOR TESTING RAISING /mbtools/cx_exception,
      test_5 FOR TESTING RAISING /mbtools/cx_exception,
      test_6 FOR TESTING RAISING /mbtools/cx_exception,
      test_7 FOR TESTING RAISING /mbtools/cx_exception,
      test_8 FOR TESTING RAISING /mbtools/cx_exception.

    DATA:
      mo_gui        TYPE REF TO /mbtools/cl_gui,
      mv_getdata    TYPE c LENGTH 256,
      mt_postdata   TYPE cnht_post_data_tab,
      mo_parameters TYPE REF TO /mbtools/cl_string_map.
