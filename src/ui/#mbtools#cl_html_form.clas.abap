  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create
      IMPORTING
        ...
        !iv_form_action TYPE csequence OPTIONAL
    ...
    METHODS command
      ...
      RETURNING
        VALUE(ro_self) TYPE REF TO /mbtools/cl_html_form.
    METHODS text
      IMPORTING
        !iv_label       TYPE csequence
    ...
    METHODS normalize_form_data
      IMPORTING
        !io_form_data       TYPE REF TO /mbtools/cl_string_map
      RETURNING
        VALUE(ro_form_data) TYPE REF TO /mbtools/cl_string_map
      RAISING
    ...
    METHODS validate_required_fields
      IMPORTING
        !io_form_data            TYPE REF TO /mbtools/cl_string_map
      RETURNING
        VALUE(ro_validation_log) TYPE REF TO /mbtools/cl_string_map
      RAISING
        /mbtools/cx_exception.
    METHODS is_empty
      IMPORTING
...
CLASS /mbtools/cl_html_form IMPLEMENTATION.
  ...
  METHOD render.
    ...
    IF mv_help_page IS NOT INITIAL.
      ...
      ri_html->add_a(
        iv_txt   = /mbtools/cl_gui_buttons=>help( )
        iv_act   = |{ /mbtools/if_html=>c_action_type-url }?url={ lv_url }|
  ...
  METHOD render_field_textarea.
    ...
    lv_rows = lines( /mbtools/cl_convert=>split_string( is_attr-value ) ).
