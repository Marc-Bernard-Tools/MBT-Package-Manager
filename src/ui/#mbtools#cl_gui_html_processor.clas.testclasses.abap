...
CLASS /mbtools/cl_gui_html_processor DEFINITION LOCAL FRIENDS ltcl_html_processor_test.
...
CLASS ltcl_html_processor_test DEFINITION
  ...
  PRIVATE SECTION.
    ...
    DATA mo_cut TYPE REF TO /mbtools/cl_gui_html_processor.
    ...
    METHODS process_fails FOR TESTING RAISING /mbtools/cx_exception.
    METHODS find_head_closing_tag FOR TESTING RAISING /mbtools/cx_exception.
ENDCLASS.
...
CLASS ltcl_html_processor_test IMPLEMENTATION.
  ...
  METHOD find_head_closing_tag.
    ...
    lv_html = '<!DOCTYPE html><html><head><title>abapGit</title><link rel="stylesheet" type="text/css" ' &&
              'href="css/common.css"><link rel="stylesheet" type="text/css" href="css/icons.css">' &&
