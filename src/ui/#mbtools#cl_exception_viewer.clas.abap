...
************************************************************************
  ...
  PRIVATE SECTION.
    DATA:
      mx_error     TYPE REF TO /mbtools/cx_exception,
...
CLASS /mbtools/cl_exception_viewer IMPLEMENTATION.
  ...
  METHOD get_top_of_callstack.
    ...
    IF sy-subrc <> 0.
      /mbtools/cx_exception=>raise( |Callstack is empty| ).
    ENDIF.
  ...
  METHOD on_double_click.
    ...
    DATA: lx_error TYPE REF TO /mbtools/cx_exception.
