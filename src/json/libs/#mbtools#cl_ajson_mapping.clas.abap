CLASS /mbtools/cl_ajson_mapping DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
************************************************************************
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create_rename
      IMPORTING
        it_rename_map TYPE /mbtools/if_ajson_mapping=>tty_rename_map
    ...
    CLASS-METHODS create_compound_mapper
      IMPORTING
        ii_mapper1 TYPE REF TO /mbtools/if_ajson_mapping OPTIONAL
        ii_mapper2 TYPE REF TO /mbtools/if_ajson_mapping OPTIONAL
        ii_mapper3 TYPE REF TO /mbtools/if_ajson_mapping OPTIONAL
        it_more TYPE /mbtools/if_ajson_mapping=>ty_table_of OPTIONAL
      RETURNING
        VALUE(ri_mapping) TYPE REF TO /mbtools/if_ajson_mapping.
...
CLASS /mbtools/cl_ajson_mapping IMPLEMENTATION.
  ...
  METHOD create_compound_mapper.
    ...
    DATA lt_queue TYPE /mbtools/if_ajson_mapping=>ty_table_of.
