CLASS ltcl_test_mappers DEFINITION FINAL FOR TESTING
  ...
  PRIVATE SECTION.
    METHODS:
      from_json_to_json FOR TESTING RAISING /mbtools/cx_ajson_error,
    ...
    METHODS:
      to_snake FOR TESTING RAISING /mbtools/cx_ajson_error,
      to_camel FOR TESTING RAISING /mbtools/cx_ajson_error,
      to_camel_1st_upper FOR TESTING RAISING /mbtools/cx_ajson_error,
      rename_by_attr FOR TESTING RAISING /mbtools/cx_ajson_error,
      rename_by_path FOR TESTING RAISING /mbtools/cx_ajson_error,
      rename_by_pattern FOR TESTING RAISING /mbtools/cx_ajson_error,
      compound_mapper FOR TESTING RAISING /mbtools/cx_ajson_error,
      test_to_upper FOR TESTING RAISING /mbtools/cx_ajson_error,
      test_to_lower FOR TESTING RAISING /mbtools/cx_ajson_error.
...
CLASS ltcl_test_mappers IMPLEMENTATION.
  ...
  METHOD from_json_to_json.
    ...
    lo_ajson =
        /mbtools/cl_ajson=>parse(
            iv_json           = `{"fieldData":"field_value"}`
            ii_custom_mapping = /mbtools/cl_ajson_mapping=>create_camel_case( iv_first_json_upper = abap_false ) ).
  ...
  METHOD test_to_upper.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>create_from(
        ii_source_json = /mbtools/cl_ajson=>parse( '{"a":1,"b":{"c":2}}' )
        ii_mapper      = /mbtools/cl_ajson_mapping=>create_upper_case( ) )->stringify( )
      exp = '{"A":1,"B":{"C":2}}' ).

    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>parse( '{"a":1,"b":{"c":2}}'
        )->map( /mbtools/cl_ajson_mapping=>create_upper_case( )
        )->stringify( )
      exp = '{"A":1,"B":{"C":2}}' ).
  ...
  METHOD test_to_lower.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>create_from(
        ii_source_json = /mbtools/cl_ajson=>parse( '{"A":1,"B":{"C":2}}' )
        ii_mapper      = /mbtools/cl_ajson_mapping=>create_lower_case( ) )->stringify( )
      exp = '{"a":1,"b":{"c":2}}' ).

    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>parse( '{"A":1,"B":{"C":2}}'
        )->map( /mbtools/cl_ajson_mapping=>create_lower_case( )
        )->stringify( )
      exp = '{"a":1,"b":{"c":2}}' ).
  ...
  METHOD rename_by_attr.
    ...
    DATA lt_map TYPE /mbtools/if_ajson_mapping=>tty_rename_map.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>create_from(
        ii_source_json = /mbtools/cl_ajson=>parse( '{"a":1,"b":{"c":2},"d":{"e":3}}' )
        ii_mapper      = /mbtools/cl_ajson_mapping=>create_rename( lt_map
        ) )->stringify( )
      exp = '{"b":{"y":2},"x":1,"z":{"e":3}}' ).
  ...
  METHOD rename_by_path.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>create_from(
        ii_source_json = /mbtools/cl_ajson=>parse( '{"a":1,"b":{"a":2},"c":{"a":3}}' )
        ii_mapper      = /mbtools/cl_ajson_mapping=>create_rename(
          it_rename_map = lt_map
          iv_rename_by  = /mbtools/cl_ajson_mapping=>rename_by-full_path
        ) )->stringify( )
      exp = '{"a":1,"b":{"x":2},"c":{"a":3}}' ).
  ...
  METHOD rename_by_pattern.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>create_from(
        ii_source_json = /mbtools/cl_ajson=>parse( '{"andthisnot":1,"b":{"thisone":2},"c":{"a":3}}' )
        ii_mapper      = /mbtools/cl_ajson_mapping=>create_rename(
          it_rename_map = lt_map
          iv_rename_by  = /mbtools/cl_ajson_mapping=>rename_by-pattern
        ) )->stringify( )
  ...
  METHOD compound_mapper.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>create_from(
        ii_source_json = /mbtools/cl_ajson=>parse( '{"a":1,"b":{"a":2},"c":{"a":3}}' )
        ii_mapper      = /mbtools/cl_ajson_mapping=>create_compound_mapper(
          ii_mapper1 = /mbtools/cl_ajson_mapping=>create_rename(
            it_rename_map = lt_map
            iv_rename_by  = /mbtools/cl_ajson_mapping=>rename_by-full_path )
          ii_mapper2 = /mbtools/cl_ajson_mapping=>create_upper_case( ) )
        )->stringify( )
      exp = '{"A":1,"B":{"X":2},"C":{"A":3}}' ).
  ...
  METHOD to_snake.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>create_from(
        ii_source_json = /mbtools/cl_ajson=>parse( '{"aB":1,"BbC":2,"cD":{"xY":3},"ZZ":4}' )
        ii_mapper      = /mbtools/cl_ajson_mapping=>create_to_snake_case( )
        )->stringify( )
  ...
  METHOD to_camel.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>create_from(
        ii_source_json = /mbtools/cl_ajson=>parse( '{"a_b":1,"bb_c":2,"c_d":{"x_y":3},"zz":4}' )
        ii_mapper      = /mbtools/cl_ajson_mapping=>create_to_camel_case( )
        )->stringify( )
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>create_from(
        ii_source_json = /mbtools/cl_ajson=>parse( '{"a__b":1}' )
        ii_mapper      = /mbtools/cl_ajson_mapping=>create_to_camel_case( )
        )->stringify( )
      exp = '{"a_b":1}' ).
  ...
  METHOD to_camel_1st_upper.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>create_from(
        ii_source_json = /mbtools/cl_ajson=>parse( '{"aj_bc":1,"bb_c":2,"c_d":{"xq_yq":3},"zz":4}' )
        ii_mapper      = /mbtools/cl_ajson_mapping=>create_to_camel_case( iv_first_json_upper = abap_true )
        )->stringify( )
...
CLASS ltcl_fields DEFINITION FINAL FOR TESTING
  ...
  PRIVATE SECTION.
    METHODS:
      to_json_without_path FOR TESTING RAISING /mbtools/cx_ajson_error,
      to_json_with_path FOR TESTING RAISING /mbtools/cx_ajson_error,
      to_abap FOR TESTING RAISING /mbtools/cx_ajson_error,
      to_json IMPORTING iv_path TYPE string RETURNING VALUE(rv_result) TYPE string RAISING /mbtools/cx_ajson_error.
