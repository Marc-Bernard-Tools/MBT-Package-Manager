...
CLASS lcl_json_parser DEFINITION FINAL.
  ...
  PRIVATE SECTION.
    ...
    TYPES:
      ty_stack_tt TYPE STANDARD TABLE OF REF TO /mbtools/cl_ajson=>ty_node.
...
CLASS lcl_json_serializer DEFINITION FINAL CREATE PRIVATE.
  PUBLIC SECTION.
    ...
    CLASS-METHODS stringify
      IMPORTING
        it_json_tree          TYPE /mbtools/cl_ajson=>ty_nodes_ts
  ...
  PRIVATE SECTION.
    ...
    DATA mt_json_tree TYPE /mbtools/cl_ajson=>ty_nodes_ts.
    ...
    METHODS stringify_node
      IMPORTING
        is_node TYPE /mbtools/cl_ajson=>ty_node
      RAISING
        /mbtools/cx_ajson_error.
...
CLASS lcl_json_to_abap DEFINITION FINAL.
  PUBLIC SECTION.
    ...
    METHODS to_abap
      IMPORTING
        it_nodes TYPE /mbtools/cl_ajson=>ty_nodes_ts
      RAISING
        /mbtools/cx_ajson_error.
...
CLASS lcl_abap_to_json DEFINITION FINAL.
  ...
  PRIVATE SECTION.
    ...
    METHODS convert_struc
      ...
      CHANGING
        ct_nodes  TYPE /mbtools/cl_ajson=>ty_nodes_tt
        cs_root   TYPE /mbtools/cl_ajson=>ty_node OPTIONAL
      RAISING
        /mbtools/cx_ajson_error.
