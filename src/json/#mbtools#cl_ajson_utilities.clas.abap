CLASS /mbtools/cl_ajson_utilities DEFINITION
  PUBLIC
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS diff
      ...
      EXPORTING
        ...
        !eo_change            TYPE REF TO /mbtools/if_ajson
      RAISING
    ...
    METHODS sort
      IMPORTING
        ...
        !io_json         TYPE REF TO /mbtools/if_ajson OPTIONAL
      RETURNING
...
CLASS /mbtools/cl_ajson_utilities IMPLEMENTATION.
    ...
    DO.
      ...
      IF iv_keep_empty_arrays = abap_false.
        LOOP AT io_json->mt_json_tree INTO ls_json_tree
          WHERE type = /mbtools/if_ajson_types=>node_type-array AND children = 0.
      ...
      LOOP AT io_json->mt_json_tree INTO ls_json_tree
        WHERE type = /mbtools/if_ajson_types=>node_type-object AND children = 0.
  ...
  METHOD diff.
    ...
    mo_insert = /mbtools/cl_ajson=>create_empty( ).
    mo_delete = /mbtools/cl_ajson=>create_empty( ).
    mo_change = /mbtools/cl_ajson=>create_empty( ).
  ...
  METHOD normalize_input.
    ...
    IF boolc( iv_json IS INITIAL ) = boolc( io_json IS INITIAL ).
      /mbtools/cx_ajson_error=>raise( 'Either supply JSON string or instance, but not both' ).
    ENDIF.

    IF iv_json IS NOT INITIAL.
      ro_json = /mbtools/cl_ajson=>parse( iv_json ).
