...
CLASS lcl_rename DEFINITION.
  ...
  PRIVATE SECTION.
    DATA mt_rename_map TYPE /mbtools/if_ajson_mapping~tty_rename_map.
...
CLASS lcl_compound_mapper DEFINITION.
  ...
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING
        it_queue TYPE /mbtools/if_ajson_mapping=>ty_table_of.

  PROTECTED SECTION.

  PRIVATE SECTION.
    DATA mt_queue TYPE /mbtools/if_ajson_mapping=>ty_table_of.
