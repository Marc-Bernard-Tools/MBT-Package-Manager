...
CLASS lcl_nodes_helper DEFINITION FINAL.
  PUBLIC SECTION.
    ...
    DATA mt_nodes TYPE /mbtools/if_ajson_types=>ty_nodes_tt.
    METHODS add
      IMPORTING
        iv_str TYPE string.
    METHODS clear.
    METHODS sorted
      RETURNING
        VALUE(rt_nodes) TYPE /mbtools/if_ajson_types=>ty_nodes_ts.
...
CLASS ltcl_parser_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS parse_keeping_order FOR TESTING RAISING /mbtools/cx_ajson_error.
...
CLASS ltcl_parser_test IMPLEMENTATION.
  ...
  METHOD parse_error.
    ...
    DATA lt_act TYPE /mbtools/if_ajson_types=>ty_nodes_tt.
    DATA lx_err TYPE REF TO /mbtools/cx_ajson_error.
    TRY.
        lt_act = mo_cut->parse( 'abc' ).
...
CLASS ltcl_serializer_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS escape_string FOR TESTING RAISING /mbtools/cx_ajson_error.
...
CLASS ltcl_utils_test IMPLEMENTATION.
  ...
  METHOD split_path.
    ...
    DATA ls_exp TYPE /mbtools/if_ajson_types=>ty_path_name.
...
CLASS ltcl_reader_test IMPLEMENTATION.
  ...
  METHOD slice.
    ...
    lo_cut ?= lo_cut->/mbtools/if_ajson~slice( '/issues' ).
    cl_abap_unit_assert=>assert_equals(
    ...
    lo_cut = /mbtools/cl_ajson=>parse( ltcl_parser_test=>sample_json( ) ).
    lo_cut ?= lo_cut->/mbtools/if_ajson~slice( '/' ).
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->mt_json_tree
      exp = lo_nodes->sorted( ) ).
    ...
    lo_cut = /mbtools/cl_ajson=>parse( ltcl_parser_test=>sample_json( ) ).
    lo_cut ?= lo_cut->/mbtools/if_ajson~slice( '/issues/2/start/' ).
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->mt_json_tree
      exp = lo_nodes->sorted( ) ).
  ...
  METHOD get_value.
    ...
    DATA lo_cut TYPE REF TO /mbtools/if_ajson.
    lo_cut ?= /mbtools/cl_ajson=>parse( ltcl_parser_test=>sample_json( ) ).
  ...
  METHOD get_node_type.
    ...
    cl_abap_unit_assert=>assert_equals(
      ...
      exp = /mbtools/if_ajson_types=>node_type-object ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/string' )
      exp = /mbtools/if_ajson_types=>node_type-string ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/number' )
      exp = /mbtools/if_ajson_types=>node_type-number ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/float' )
      exp = /mbtools/if_ajson_types=>node_type-number ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/boolean' )
      exp = /mbtools/if_ajson_types=>node_type-boolean ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/false' )
      exp = /mbtools/if_ajson_types=>node_type-boolean ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/null' )
      exp = /mbtools/if_ajson_types=>node_type-null ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/date' )
      exp = /mbtools/if_ajson_types=>node_type-string ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/issues' )
      exp = /mbtools/if_ajson_types=>node_type-array ).
  ...
  METHOD get_date.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->/mbtools/if_ajson~get_date( '/date1' )
      exp = lv_exp ).
  ...
  METHOD get_timestamp.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->/mbtools/if_ajson~get_timestamp( '/timestamp' )
      exp = lv_exp ).
  ...
  METHOD array_to_string_table.
    ...
    lt_act = lo_cut->/mbtools/if_ajson~array_to_string_table( '/' ).
    cl_abap_unit_assert=>assert_equals(
      act = lt_act
      exp = lt_exp ).
    ...
    TRY.
        lo_cut->/mbtools/if_ajson~array_to_string_table( '/x' ).
        cl_abap_unit_assert=>fail( ).
      CATCH /mbtools/cx_ajson_error INTO lx.
        cl_abap_unit_assert=>assert_equals(
          act = lx->message
    ...
    TRY.
        lo_cut->/mbtools/if_ajson~array_to_string_table( '/' ).
        cl_abap_unit_assert=>fail( ).
      CATCH /mbtools/cx_ajson_error INTO lx.
        cl_abap_unit_assert=>assert_equals(
          act = lx->message
    ...
    TRY.
        lo_cut->/mbtools/if_ajson~array_to_string_table( '/a' ).
        cl_abap_unit_assert=>fail( ).
      CATCH /mbtools/cx_ajson_error INTO lx.
        cl_abap_unit_assert=>assert_equals(
          act = lx->message
...
CLASS ltcl_writer_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS set_obj_w_date_time FOR TESTING RAISING /mbtools/cx_ajson_error.
    METHODS set_tab FOR TESTING RAISING /mbtools/cx_ajson_error.
    METHODS set_tab_hashed FOR TESTING RAISING /mbtools/cx_ajson_error.
    METHODS set_tab_nested_struct FOR TESTING RAISING /mbtools/cx_ajson_error.
    ...
    METHODS setx_float FOR TESTING RAISING /mbtools/cx_ajson_error.
    METHODS setx_complex FOR TESTING RAISING /mbtools/cx_ajson_error.
    METHODS setx_complex_w_keep_order FOR TESTING RAISING /mbtools/cx_ajson_error.

    METHODS set_with_type_slice
      IMPORTING
        io_json_in TYPE REF TO /mbtools/cl_ajson
        io_json_out TYPE REF TO /mbtools/if_ajson
        iv_path TYPE string
      RAISING
...
CLASS ltcl_writer_test IMPLEMENTATION.
  ...
  METHOD delete.
    ...
    lo_cut->/mbtools/if_ajson~delete( iv_path = '/a/b' ).
  ...
  METHOD set_obj_w_date_time.
    ...
    lo_cut = /mbtools/cl_ajson=>create_empty( )->format_datetime( ).
    li_writer = lo_cut.
  ...
  METHOD setx.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>new( )->setx( '/a:1' )->stringify( )
      exp = '{"a":1}' ).
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>new( )->setx( '/a:abc' )->stringify( )
      exp = '{"a":"abc"}' ).

    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>new( )->setx( '/a:null' )->stringify( )
      exp = '{"a":null}' ).

    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>new( )->setx( '/a:true' )->stringify( )
      exp = '{"a":true}' ).
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>new( )->setx( '/a:false' )->stringify( )
      exp = '{"a":false}' ).

    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>new( )->setx( '/a/b:1' )->stringify( )
      exp = '{"a":{"b":1}}' ).

    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>new( )->setx( '/:1' )->stringify( )
...
*      exp = '{}' ). " should setx ignore empty values or set an empty string ? Or null ?
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>new( )->setx( '/a:""' )->stringify( )
      exp = '{"a":""}' ).
  ...
  METHOD setx_float.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>new( )->setx( '/a:1.123' )->stringify( )
      exp = '{"a":1.123}' ).

    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>new( )->setx( '/a:00.123' )->stringify( )
      exp = '{"a":"00.123"}' ). " not a number

    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>new( )->setx( '/a:.123' )->stringify( )
      exp = '{"a":".123"}' ).
  ...
  METHOD setx_complex.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /mbtools/cl_ajson=>new( )->setx( '/a:[1, 2]' )->stringify( )
      exp = '{"a":[1,2]}' ).
    ...
    TRY.
        /mbtools/cl_ajson=>new( )->setx( '/a:{"b" : 1' ).
        cl_abap_unit_assert=>fail( ).
      CATCH /mbtools/cx_ajson_error.
    ENDTRY.

    TRY.
        /mbtools/cl_ajson=>new( )->setx( '/a:[1, 2' ).
        cl_abap_unit_assert=>fail( ).
      CATCH /mbtools/cx_ajson_error.
    ENDTRY.
  ...
  METHOD setx_complex_w_keep_order.
    ...
    li_cut = /mbtools/cl_ajson=>new( iv_keep_item_order = abap_true ).
    li_cut->setx( '/c:3' ).
    li_cut->set(
      iv_path = '/b'
      iv_val  = ls_dummy ).
...
CLASS ltcl_integrated IMPLEMENTATION.
  ...
  METHOD array_simple.
    ...
    DATA li_reader TYPE REF TO /mbtools/if_ajson.
  ...
  METHOD stringify.
    ...
    DATA: BEGIN OF ls_data, str TYPE string, cls TYPE REF TO /mbtools/cl_ajson, END OF ls_data.
  ...
  METHOD push_json.
    ...
    DATA li_cut TYPE REF TO /mbtools/if_ajson.
    DATA li_sub TYPE REF TO /mbtools/if_ajson.
    DATA lv_act TYPE string.
    DATA lv_exp TYPE string.

    li_cut = /mbtools/cl_ajson=>create_empty( ).
    li_sub = /mbtools/cl_ajson=>create_empty( )->set(
      iv_path = 'a'
      iv_val  = '1' ).
    ...
    li_cut->push(
      iv_path = '/list'
      iv_val  = /mbtools/cl_ajson=>create_empty( )->set(
        iv_path = 'a'
        iv_val  = '1' ) ).
    li_cut->push(
      iv_path = '/list'
...
CLASS ltcl_abap_to_json DEFINITION
  ...
  PRIVATE SECTION.
    ...
    METHODS set_ajson FOR TESTING RAISING /mbtools/cx_ajson_error.
    METHODS set_value_number FOR TESTING RAISING /mbtools/cx_ajson_error.
    METHODS set_value_string FOR TESTING RAISING /mbtools/cx_ajson_error.
    ...
    METHODS set_include_with_suffix FOR TESTING RAISING /mbtools/cx_ajson_error.
...
CLASS ltcl_abap_to_json IMPLEMENTATION.
  ...
  METHOD set_ajson.
    ...
    DATA lt_nodes TYPE /mbtools/if_ajson_types=>ty_nodes_tt.
  ...
  METHOD prefix.
    ...
    DATA lo_nodes_exp TYPE REF TO lcl_nodes_helper.
    DATA lt_nodes TYPE /mbtools/if_ajson_types=>ty_nodes_tt.
    DATA ls_prefix TYPE /mbtools/if_ajson_types=>ty_path_name.
  ...
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF ty_visit_history,
        path TYPE string,
        type TYPE /mbtools/if_ajson_filter=>ty_visit_type,
      END OF ty_visit_history.

    DATA mt_visit_history TYPE TABLE OF ty_visit_history.

    METHODS simple_test FOR TESTING RAISING /mbtools/cx_ajson_error.
    METHODS array_test FOR TESTING RAISING /mbtools/cx_ajson_error.
    METHODS visit_types FOR TESTING RAISING /mbtools/cx_ajson_error.
...
CLASS ltcl_filter_test IMPLEMENTATION.
  ...
  METHOD simple_test.
    ...
    DATA lo_json_filtered TYPE REF TO /mbtools/cl_ajson.
    DATA lo_nodes_exp TYPE REF TO lcl_nodes_helper.
  ...
  METHOD visit_types.
    ...
    <v>-path = '/'.
    <v>-type = /mbtools/if_ajson_filter=>visit_type-open.
    APPEND INITIAL LINE TO lt_visits_exp ASSIGNING <v>.
    <v>-path = '/3/'.
    <v>-type = /mbtools/if_ajson_filter=>visit_type-open.
    APPEND INITIAL LINE TO lt_visits_exp ASSIGNING <v>.
    <v>-path = '/3/'.
    <v>-type = /mbtools/if_ajson_filter=>visit_type-close.
    APPEND INITIAL LINE TO lt_visits_exp ASSIGNING <v>.
    <v>-path = '/'.
    <v>-type = /mbtools/if_ajson_filter=>visit_type-close.
...
CLASS ltcl_mapper_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS simple_test FOR TESTING RAISING /mbtools/cx_ajson_error.
    METHODS array_test FOR TESTING RAISING /mbtools/cx_ajson_error.
    METHODS duplication_test FOR TESTING RAISING /mbtools/cx_ajson_error.
    METHODS empty_name_test FOR TESTING RAISING /mbtools/cx_ajson_error.
    METHODS trivial FOR TESTING RAISING /mbtools/cx_ajson_error.

ENDCLASS.

CLASS ltcl_mapper_test IMPLEMENTATION.

  METHOD /mbtools/if_ajson_mapping~rename_node.
    IF cv_name+0(1) = 'a'.
...
CLASS ltcl_cloning_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS clone_test FOR TESTING RAISING /mbtools/cx_ajson_error.
    METHODS filter_test FOR TESTING RAISING /mbtools/cx_ajson_error.
    METHODS mapper_test FOR TESTING RAISING /mbtools/cx_ajson_error.
    METHODS mapper_and_filter FOR TESTING RAISING /mbtools/cx_ajson_error.
    METHODS opts_copying FOR TESTING RAISING /mbtools/cx_ajson_error.
...
CLASS ltcl_cloning_test IMPLEMENTATION.
  ...
  METHOD clone_test.
    ...
    DATA li_json TYPE REF TO /mbtools/if_ajson.
    DATA li_json_new TYPE REF TO /mbtools/if_ajson.
    DATA lo_nodes_exp TYPE REF TO lcl_nodes_helper.
  ...
  METHOD mapper_and_filter.
    ...
    li_json_new = /mbtools/cl_ajson=>create_from(
  ...
  METHOD opts_copying.
    ...
    li_json = /mbtools/cl_ajson=>new( )->keep_item_order( ).
    li_json->set(
      iv_path = '/ab'
      iv_val  = 1 ).
